...
// Aggiungere qui la dichiarazione della funzione compute_sum
...
int main(int argc, char **argv) {
  ...
  cout << "The value of compute_sum(" << num << ") = " << compute_sum(num)
       << endl;
}

// Aggiungere qui la definizione della funzione compute_sum
